...
impl<T, B> core::cmp::PartialEq<B> for BitFlags<T>
where
    T: RawBitFlags,
...
impl<T, B> core::ops::BitOrAssign<B> for BitFlags<T>
where
    T: RawBitFlags,
    B: Into<BitFlags<T>>,
{
...
impl<T, B> core::ops::BitAndAssign<B> for BitFlags<T>
where
    T: RawBitFlags,
    B: Into<BitFlags<T>>,
{
...
impl<T, B> core::ops::BitXorAssign<B> for BitFlags<T>
where
    T: RawBitFlags,
    B: Into<BitFlags<T>>,
{
